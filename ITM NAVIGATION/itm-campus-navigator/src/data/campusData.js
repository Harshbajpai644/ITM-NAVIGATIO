...
export const BLOCKS = [
  ...
  },
  {
    ...
    people: [
      // Ground Floor
      { name: "Dr. Mukesh Pandety", designation: "Dean Office", room: "103" },
      { name: "Dr. Sanjay Jain", designation: "Faculty", room: "105" },
      { name: "Dr. Nidhi Dandotiya", designation: "Faculty", room: "109" },
      { name: "Dr. Keerti Shrivastava", designation: "Faculty", room: "112" },
      { name: "Dr. Manali Shukla", designation: "Faculty", room: "114" },
      { name: "Dr. Geetanjali Surange", designation: "Faculty", room: "115" },
      { name: "Mr. Suraj Sharma", designation: "Faculty", room: "117" },
      { name: "Mr. Yash Jha", designation: "Faculty", room: "117" },
      { name: "Mr. V. Naveen Chainlu", designation: "Faculty", room: "117" },
      { name: "Mr. Hirendra Singh Sengar", designation: "Faculty", room: "117" },
      { name: "Dr. Pallavi Khatri", designation: "Faculty", room: "122" },
      // First Floor
      { name: "Ms. Bharati Gole", designation: "Faculty", room: "206" },
      { name: "Ms. Anjali Saraswat", designation: "Faculty", room: "206" },
      { name: "Mr. Shubham Dhakarey", designation: "Faculty", room: "206" },
      { name: "Ms. Gauri Sharma", designation: "Faculty", room: "206" },
      { name: "Dr. Shashikant Gupta", designation: "Faculty", room: "211" },
      // Second Floor
      { name: "Ms. Pooja Sengar", designation: "Faculty", room: "307" },
      { name: "Ms. Anchal Bhatt", designation: "Faculty", room: "307" },
      { name: "Ms. Anisha Agrawal", designation: "Faculty", room: "307" },
      { name: "Ms. Manali Singh", designation: "Faculty", room: "307" },
      { name: "Mr. H.N. Verma", designation: "Faculty", room: "PCB-300" },
      { name: "Mr. Neeraj Goyal", designation: "Faculty", room: "309" },
      { name: "Mr. Vipin Jadon", designation: "Faculty", room: "309" },
      { name: "Mr. Manoj Sharma", designation: "Faculty", room: "309" },
      { name: "Mr. Manish Kumar Jain", designation: "Faculty", room: "309" },
      { name: "Mr. Saurabh Chaturvedi", designation: "Faculty", room: "309" },
      { name: "Mr. Ashish Singh Yadav", designation: "Faculty", room: "309" },
      { name: "Mr. Somesh Sharma", designation: "Faculty", room: "309" },
      // Third Floor
      { name: "Dr. Aravendra Kumar Sharma", designation: "Faculty", room: "404" },
      { name: "Mr. Gajendra Singh Rajput", designation: "Faculty", room: "404" },
      { name: "Mr. Sudhir Sharma", designation: "Faculty", room: "404" },
      { name: "Ms. Anupama Bhadauriya", designation: "Faculty", room: "404" },
      { name: "Ms. Pragya Jain", designation: "Faculty", room: "404" },
      // Fourth Floor
      { name: "Dr. Rakesh Prasad Sarang", designation: "Faculty", room: "504" },
      { name: "Dr. Anjali Kedawat", designation: "Faculty", room: "504" },
      { name: "Dr. Jyoti Balakaundal", designation: "Faculty", room: "504" },
    ],
  },
  {
    id: "ldv-block",
