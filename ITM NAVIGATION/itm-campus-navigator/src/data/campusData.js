 ...
 * Library / Admission / LDV shared one pin — slight offsets so markers don't stack.
 * Boys hostel pin was incomplete — placed along Hostel Road (confirm exact pin).
 */
export const BLOCKS = [
  {
    id: "admission",
  ...
  },
  {
    ...
    description:
      "Offering industry-focused education across Computer Science, Artificial Intelligence & Data Science, Information Technology, Electronics & Communication, Electrical, Mechanical, Civil, and related engineering disciplines.",
  ...
  },
  {
    ...
    description:
      "Offering industry-focused programs in BBA, MBA, B.Com, M.Com, Hospitality & Hotel Management, Tourism Management, and related business disciplines.",
  ...
  },
  {
    ...
    description:
      "Offering comprehensive programs B.Sc. Nursing, Post Basic B.Sc. Nursing, and M.Sc. Nursing, with advanced clinical training.",
  ...
  },
  {
    ...
    description:
      "A fully air-conditioned library with spacious seating, an extensive collection of books and digital resources.",
  ...
  },
  {
    ...
    description:
      "Fostering creativity and innovation through industry-focused education in fashion and design.",
  ...
  },
  {
    ...
    description:
      "Comfortable campus living with spacious rooms, 24/7 security, and mess facilities.",
  ...
  },
  {
    ...
    description: "Sports and fitness facilities for students.",
    hours: "9 AM – 5 PM",
  ...
  },
  {
    ...
    description: "Campus canteen with fresh meals and refreshments.",
    hours: "Mon–Sat, 8:00 AM – 8:00 PM",
